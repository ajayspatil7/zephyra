...
class ZephyraResolve(nn.Module):
    def __init__(
        ...
        max_seq_length: int,
        dropout: float = 0.1,
        tokenizer_path: Optional[str] = '/Users/ajay/Downloads/zephyra/project/src/tokenizer.json'
    ):
        super().__init__()
...
if __name__ == "__main__":
    ...
    input_ids = model.encode(input_text).unsqueeze(0)  # Add batch dimension

    # Generate output
    output_ids = model.generate(input_ids, max_length=50, temperature=0.7, top_k=50)
